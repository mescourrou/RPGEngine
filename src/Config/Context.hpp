...
private:
    ...
    const std::string m_kRessourcesDirPath = "ressources";      ///< Path of the ressource directory
    const std::string m_kMapDirPath = "map";                    ///< Name of the map directory
    const std::string m_kCharacterDirPath = "character";        ///< Name of the character directory
